...
export const metadata: Metadata = {
  title: 'About Sosei - Unbothered Company',
  description: 'Learn about Sosei and the philosophy behind Unbothered Company',
}
      ...
      <main className="max-w-3xl mx-auto px-6 md:px-8 py-20 pt-32">
        <article className="prose prose-invert max-w-none">
          ...
          <p className="text-lg text-foreground/90 leading-relaxed mb-8 text-center">
            I&apos;m Sosei, a writer and thinker exploring how intentional choices shape our lives. My work centers on the philosophy 
